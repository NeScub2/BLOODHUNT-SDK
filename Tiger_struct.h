...
enum class ETigerBuyStoreEntryResponseCode : uint8 {
	...
	Error_NoDatabase = 14,
	ETigerBuyStoreEntryResponseCode_MAX = 15
};
...
enum class ETigerRewardReason : uint8 {
	Unknown = 0,
	Battlepass = 1,
	Challenge = 2,
...
enum class ETigerCustomizationType : int32 {
	...
	Emotes = 131072,
	All = 262143,
	ETigerCustomizationType_MAX = 262144
};
...
enum class ETigerInboxMessageCategory : uint8 {
	...
	PrimeLoot = 1,
	Count = 2,
	ETigerInboxMessageCategory_MAX = 3
};
...
enum class ETigerMatchSettingsVariationParameter : uint8 {
	GasSpeed = 0,
	CivilianResonance = 1,
	SwapLootTable = 2,
	DisableEntity = 3,
...
enum class ETigerReplayInputMode : uint8 {
	Movement = 0,
	Rotation = 1,
	Playback = 2,
	Keyframing = 3,
	ETigerReplayInputMode_MAX = 4
};
...
enum class ETigerPersistentStatsCategory : uint8 {
	...
	TimeUntilPlay = 5,
	Count = 6,
	ETigerPersistentStatsCategory_MAX = 7
};
...
struct FTigerCharacterStatModification {
	...
	float AbilityDamageTakenMultiplier; // 0x80(0x04)
	float ShootingDamageTakenMultiplier; // 0x84(0x04)
	float MosquitoDamageTakenMultiplier; // 0x88(0x04)
	float HealingReceivedMultiplier; // 0x8c(0x04)
	float LoudnessMultiplier; // 0x90(0x04)
	float ReviveSpeedMultiplier; // 0x94(0x04)
	float ExperienceGainMultiplier; // 0x98(0x04)
	float AimSensitivityMultiplier; // 0x9c(0x04)
};
...
struct FTigerNonReplicatedCharacterStats {
	...
	float HealingReceivedMultiplier; // 0x28(0x04)
	float CooldownMultiplier; // 0x2c(0x04)
	float CooldownSpeedMultiplier; // 0x30(0x04)
	float RechargeMultiplier; // 0x34(0x04)
	float RechargeSpeedMultiplier; // 0x38(0x04)
	float MasqueradePointMultiplier; // 0x3c(0x04)
	float MasqueradeConsequenceDurationMultiplier; // 0x40(0x04)
	float BloodhuntDurationMultiplier; // 0x44(0x04)
	float ClanSkillCooldownMultiplier; // 0x48(0x04)
	float ArchetypeSkillCooldownMultiplier; // 0x4c(0x04)
	float AttackSpeedMultiplier; // 0x50(0x04)
	float ReloadSpeedMultiplier; // 0x54(0x04)
	float ShootingDamageDealtMultiplier; // 0x58(0x04)
	float ShotgunDamageDealtMultiplier; // 0x5c(0x04)
	float StaminaCostMultiplier; // 0x60(0x04)
	float AmmoFindMultiplier; // 0x64(0x04)
	float AmmoCapacityMultiplier; // 0x68(0x04)
	float FeedSpeedMultiplier; // 0x6c(0x04)
	float MosquitoDamageTakenMultiplier; // 0x70(0x04)
	float LoudnessMultiplier; // 0x74(0x04)
	float ExperienceGainMultiplier; // 0x78(0x04)
	float AimSensitivityMultiplier; // 0x7c(0x04)
	float DamageDealtMultiplier; // 0x80(0x04)
	float DamageDealtToCiviliansMultiplier; // 0x84(0x04)
};
...
struct FTigerMatchSettings {
	...
	int32_t StartingResonance; // 0x08(0x04)
	enum class ETigerMatchSettingState StartingResonanceSettingState; // 0x0c(0x01)
	bool bAllHighTierLootActive; // 0x0d(0x01)
	enum class ETigerMatchSettingState AllHighTierLootActiveSettingState; // 0x0e(0x01)
	bool bBrokenMasqueradeAtStart; // 0x0f(0x01)
	enum class ETigerMatchSettingState BrokenMasqueradeAtStartSettingState; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
	int32_t HealthMax; // 0x14(0x04)
	enum class ETigerMatchSettingState HealthMaxSettingState; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	int32_t HealthStart; // 0x1c(0x04)
	enum class ETigerMatchSettingState HealthStartSettingState; // 0x20(0x01)
	char pad_21[0x3]; // 0x21(0x03)
	int32_t ShieldHpValue; // 0x24(0x04)
	enum class ETigerMatchSettingState ShieldHpSettingState; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	int32_t ShieldStackCount; // 0x2c(0x04)
	enum class ETigerMatchSettingState ShieldStackCountSettingState; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	int32_t ShieldStartCount; // 0x34(0x04)
	enum class ETigerMatchSettingState ShieldStartCountSettingState; // 0x38(0x01)
	char pad_39[0x3]; // 0x39(0x03)
	float RegenerationTimeSolo; // 0x3c(0x04)
	enum class ETigerMatchSettingState RegenerationTimeSoloSettingState; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	float RegenerationTimeGroup; // 0x44(0x04)
	enum class ETigerMatchSettingState RegenerationTimeGroupSettingState; // 0x48(0x01)
...
struct FTigerPersistentPlayerCharacter {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FTigerPersistentPlayerCharacterData Data; // 0x08(0xd8)
	int64_t LastUsedAt; // 0xe0(0x08)
};
...
struct FTigerPersistentPlayerCharacterData {
	...
	char pad_1[0x7]; // 0x01(0x07)
	struct FTigerCharacterAppearance CharacterAppearance; // 0x08(0xc0)
	struct TArray<uint64_t> SelectedPerks; // 0xc8(0x10)
};
...
struct FTigerCharacterAppearance {
	...
	enum class ETigerGender BodyType; // 0xa8(0x01)
	char pad_A9[0x7]; // 0xa9(0x07)
	struct TArray<uint64_t> EmoteIds; // 0xb0(0x10)
};
...
struct FTigerPersistentPlayerData {
	...
	struct FTigerPersistentSeasonMatchStats SeasonMatchStats; // 0xa0(0x20)
	struct FTigerLocationPersistentProgress LocationProgress; // 0xc0(0x50)
	int32_t MatchesPlayed; // 0x110(0x04)
	char pad_114[0x4]; // 0x114(0x04)
	struct TArray<int32_t> MatchesPlayedPerArchetype; // 0x118(0x10)
	struct TArray<struct FTigerGrimoireEntryStatusStruct> GrimoireEntries; // 0x128(0x10)
	struct TArray<int32_t> ReadDialogues; // 0x138(0x10)
	struct TArray<struct FTigerPersistentThrallData> PersistentThrallData; // 0x148(0x10)
	struct TArray<struct FTigerPersistentMissionData> PersistentThrallMissions; // 0x158(0x10)
	struct TArray<struct FTigerPersistentCollectibleData> PersistentCollectibleData; // 0x168(0x10)
	int32_t SharedThrallExp; // 0x178(0x04)
	char pad_17C[0x4]; // 0x17c(0x04)
	struct FTigerSuggestedArticlesData GrimoireSuggestedArticlesData; // 0x180(0x18)
	struct TArray<struct FTigerReadDialogueCategoryWrapper> ReadDialogueCategoriesContainer; // 0x198(0x10)
};
...
struct FTigerPersistentPlayerTransactionalData {
	...
	int64_t PlayerLevel; // 0x68(0x08)
	int64_t PlayerLevelExp; // 0x70(0x08)
...
struct FTigerSeasonConfig {
	...
	struct FTigerSeasonConfig_ArchetypeRewards ArchetypeLevelRewards; // 0xa0(0x80)
	struct TArray<struct FTigerSeasonConfig_WeeklyChallengeCollection> WeeklyChallenges; // 0x120(0x10)
	struct FTigerItemId DailyChallengeExpReward; // 0x130(0x08)
	struct FTigerItemId PersistentDailyChallengeTokenReward; // 0x138(0x08)
	struct FTigerSeasonConfig_DailyRewardCollection DailyRewards; // 0x140(0x20)
	struct FName DefaultVendorSubLevelName; // 0x160(0x08)
	struct FTigerItemId SoftCurrencyMatchRewardItemId; // 0x168(0x08)
	float SoftCurrencyMatchRewardMultiplier; // 0x170(0x04)
	char pad_174[0x4]; // 0x174(0x04)
	struct FRuntimeFloatCurve SoftCurrencyPlacementBonus; // 0x178(0x88)
	struct FTigerSeasonExperiences SeasonExperiences; // 0x200(0xc8)
	struct FTigerPlayerExperiences PlayerExperiences; // 0x2c8(0x40)
	struct FTigerExpLevelRequirements SeasonExpRequirements; // 0x308(0x18)
	struct FTigerExpLevelRequirements ArchetypeExpRequirements; // 0x320(0x18)
	struct FTigerExpLevelRequirements PlayerExpRequirements; // 0x338(0x18)
};
...
struct FTigerSeasonConfig_ArchetypeRewards {
	struct FTigerSeasonConfig_Archetypes Archetypes[0x8]; // 0x00(0x80)
};
...
struct FTigerPreviewerData {
	...
	struct TArray<struct TSoftClassPtr<UObject>> Emotes; // 0x240(0x10)
	struct TSoftClassPtr<UObject> CurrentOutfitConfig; // 0x250(0x28)
	struct TSoftClassPtr<UObject> CombinedItem; // 0x278(0x28)
...
struct FTigerRewardsWithReasons {
	struct TArray<struct FTigerItemId> ItemRewards; // 0x00(0x10)
	struct TArray<struct FTigerRewardReason> Reasons; // 0x10(0x10)
};

// ScriptStruct Tiger.TigerRewardReason
// Size: 0x08 (Inherited: 0x00)
struct FTigerRewardReason {
	enum class ETigerRewardReason ReasonType; // 0x00(0x01)
	char pad_1[0x3]; // 0x01(0x03)
...
struct FTigerProgressedChallengeWrapper {
	...
	enum class ETigerChallengeCategory ChallengeType; // 0x24(0x01)
	bool bHasTiers; // 0x25(0x01)
	char pad_26[0x2]; // 0x26(0x02)
	int32_t Tier; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct TArray<int32_t> TieredTargetValues; // 0x30(0x10)
	struct FTigerChallengeTypeID ChallengeTypeID; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
	struct UTigerInventoryItemBase* ChallengeReward; // 0x48(0x08)
};
...
struct FTigerPerformanceStates {
	...
	char pad_1[0x3]; // 0x01(0x03)
	struct FTigerPerformanceStateLatchData ServerPerformance; // 0x04(0x0c)
	struct FTigerPerformanceStateLatchData FramesPerSecond; // 0x10(0x0c)
	struct FTigerPerformanceStateLatchData PacketLoss; // 0x1c(0x0c)
	struct FTigerPerformanceStateLatchData Latency; // 0x28(0x0c)
	struct FTigerPerformanceStateLatchData LatencyVariation; // 0x34(0x0c)
	struct FTigerPerformanceStateLatchData RefreshRate; // 0x40(0x0c)
	struct FTigerPerformanceStateLatchData PsoCompilation; // 0x4c(0x0c)
...
struct FTigerRespawnFeatureSettings {
	int32_t MaxLifeTokens; // 0x00(0x04)
	int32_t InitialLifeTokens; // 0x04(0x04)
	int32_t DisableRespawnAtWaveNumber; // 0x08(0x04)
	int32_t NumSpawnPointsToEvaluate; // 0x0c(0x04)
	float EnemyAvoidanceDistance; // 0x10(0x04)
	char pad_14[0x4]; // 0x14(0x04)
	struct UCurveFloat* EnemyAvoidanceScoringCurve; // 0x18(0x08)
	float RespawnTime; // 0x20(0x04)
	float GhostModeDuration; // 0x24(0x04)
	float RespawnHealthRatio; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct TSoftClassPtr<UObject> GhostBuffClass; // 0x30(0x28)
	bool bDropWeapons; // 0x58(0x01)
	bool bEnableDownState; // 0x59(0x01)
	char pad_5A[0x6]; // 0x5a(0x06)
	struct TArray<enum class ETigerPlayerEvent> PlayerEventsThatIncreasesLives; // 0x60(0x10)
	struct TArray<struct FTigerItemData> ItemDroppedOnDeath; // 0x70(0x10)
	struct TArray<struct FTigerItemData> ItemsAddedOnRespawn; // 0x80(0x10)
};
...
struct FTigerRecapData {
	...
	int32_t NumberOfSpectators; // 0xd8(0x04)
...
struct FTigerFullCharacterAppearance {
	struct FTigerCharacterAppearance PartialCharacterAppearance; // 0x00(0xc0)
	struct FTigerPersistentPlayerCardData PlayerCardData; // 0xc0(0x18)
};
...
struct FTigerGameModeConfig {
	...
	struct FTigerDsSettings DsSettings; // 0x90(0x1a8)
	struct FString TelemetryID; // 0x238(0x10)
};
...
struct FTigerClusteredItem : FFastArraySerializerItem {
	char pad_C[0x4]; // 0x0c(0x04)
	struct FTransform Transform; // 0x10(0x30)
	struct FVector_NetQuantize100 Velocity; // 0x40(0x0c)
	char pad_4C[0x4]; // 0x4c(0x04)
	struct UTigerItemAsset* Item; // 0x50(0x08)
	uint32_t ItemCount; // 0x58(0x04)
	uint32_t ItemUID; // 0x5c(0x04)
	uint32_t PlayerIdWhoDroppedItem; // 0x60(0x04)
	enum class ETigerTelemetryItemSourceID ItemSource; // 0x64(0x01)
...
struct FTigerMatchSettingsVariationConfig {
	...
	char pad_14[0x4]; // 0x14(0x04)
	double BloodhuntedTimeSeconds; // 0x18(0x08)
	bool AllHighTierLootActive; // 0x20(0x01)
	bool BrokenMasqueradeAtStart; // 0x21(0x01)
	char pad_22[0x6]; // 0x22(0x06)
	struct TArray<struct FTigerMatchSettingsVariationParameterSet> ParameterSets; // 0x28(0x10)
};

// ScriptStruct Tiger.TigerMatchSettingsVariationParameterSet
// Size: 0x18 (Inherited: 0x00)
struct FTigerMatchSettingsVariationParameterSet {
	struct TArray<enum class ETigerMatchSettingsVariationParameter> Parameters; // 0x00(0x10)
...
struct FTigerModularListItemInfo {
	...
	bool bIsLocked; // 0x18(0x01)
	bool bShowProgressCounter; // 0x19(0x01)
	char pad_1A[0x2]; // 0x1a(0x02)
...
struct FTigerNpcDialogue {
	...
	struct FTigerQuestIdentifier QuestToStartId; // 0x50(0x30)
	struct TArray<struct FTigerGrimoireUnlock> GrimoireUnlocks; // 0x80(0x10)
	bool bSuperfluousAudio; // 0x90(0x01)
	char pad_91[0x7]; // 0x91(0x07)
	struct UAkAudioEvent* DialogueAudio; // 0x98(0x08)
	struct UAnimMontage* AnimationToPlay; // 0xa0(0x08)
	uint32_t EventId; // 0xa8(0x04)
...
struct FTigerSeasonConfigResponse_ArchetypeRewards {
	struct FTigerSeasonConfigResponse_Archetypes Archetypes[0x8]; // 0x00(0x80)
};
...
struct FTigerRequest_UpdateCharacter {
	struct FTigerPersistentPlayerCharacterData CharacterData; // 0x00(0xd8)
};
...
struct FTigerTelemetryEventPerf_PsoCompile : FSharkTelemetryEventBase {
	struct FSharkTelemetryDateTime dtEventTime; // 0x08(0x01)
	char pad_9[0x7]; // 0x09(0x07)
	struct FString Uin; // 0x10(0x10)
	struct FString GameAppid; // 0x20(0x10)
	...
	int32_t PlatID; // 0x40(0x04)
	char pad_44[0x4]; // 0x44(0x04)
	struct FString MatName; // 0x48(0x10)
	int32_t MapID; // 0x58(0x04)
	char pad_5C[0x4]; // 0x5c(0x04)
	struct FString PerfBatchID; // 0x60(0x10)
};
...
struct FTigerPlayerTrackerStats {
	...
	int32_t Placement; // 0x40(0x04)
	int32_t Kills; // 0x44(0x04)
	int32_t Assists; // 0x48(0x04)
	int32_t TimeAlive; // 0x4c(0x04)
	int32_t AlliesRevived; // 0x50(0x04)
	int32_t Diableries; // 0x54(0x04)
	int32_t DamageDone; // 0x58(0x04)
	int32_t DistanceTraveled; // 0x5c(0x04)
	int32_t Deaths; // 0x60(0x04)
	int32_t ArchetypeIndex; // 0x64(0x04)
	int32_t ArchetypeLevel; // 0x68(0x04)
	char pad_6C[0x4]; // 0x6c(0x04)
	struct TMap<struct FString, struct FTigerRangedWeaponTrackerStats> RangedWeaponStats; // 0x70(0x50)
	struct TMap<struct FString, struct FTigerMeleeWeaponTrackerStats> MeleeWeaponStats; // 0xc0(0x50)
	int32_t PlayerLevel; // 0x110(0x04)
	int32_t PlayerRankPoints; // 0x114(0x04)
	int32_t PlayerSeasonLevel; // 0x118(0x04)
	char pad_11C[0x4]; // 0x11c(0x04)
	struct FString PlayerIconId; // 0x120(0x10)
	struct FTigerPlayerMedalsEarned PlayerMedalsEarned; // 0x130(0x10)
};
...
struct FTigerInputSettings {
	struct FTigerControllerSettings KeyboardMouseSettings; // 0x00(0x28)
	struct FTigerControllerSettings GamepadSettings; // 0x28(0x28)
	struct FTigerGamepadSpecificSettings GamepadSpecificSettings; // 0x50(0x08)
	bool bUseAutoSprint; // 0x58(0x01)
	bool bHoldForHeightenedSenses; // 0x59(0x01)
	bool bHoldToAimDownSights; // 0x5a(0x01)
...
struct FTigerGamepadSpecificSettings {
	float RumbleIntensity; // 0x00(0x04)
	bool bEnableAimAssistSlowDown; // 0x04(0x01)
	bool bEnableAimAssistRotation; // 0x05(0x01)
	bool bEnableAdaptiveTriggers; // 0x06(0x01)
	bool bEnableAdaptiveTriggerVibration; // 0x07(0x01)
};
